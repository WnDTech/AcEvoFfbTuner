...
public sealed class AsetekDeviceDetector : IPlatformDeviceDetector
{
    public string PlatformName => "Asetek (stub)";
    public WheelbaseVendor Vendor => WheelbaseVendor.Asetek;
